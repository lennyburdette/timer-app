...
@synthesize filePath, steps;

- (void)getStepsFromFile:(NSString *)path {
	self.filePath = path;
	self.steps = [[NSArray alloc] initWithContentsOfFile:path];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
	NSDictionary *dict = [steps objectAtIndex:indexPath.row];
	cell.textLabel.text = [dict objectForKey:@"Title"];
	cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ seconds", [dict objectForKey:@"Duration"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	timerViewController.steps = steps;
